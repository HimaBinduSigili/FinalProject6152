...
if __name__ == "__main__":
    ...
    bW.myEnvironment(world, 6, 6, 0.3)
    ...
    robot=[]
    robot.append(turtlebot(world.robot(0), "turtle", vis))
    robot[0].setAltitude(0.02)
    
    robot.append(sphero6DoF(world.robot(1), "sphero", vis))
    ...
    while vis.shown() and (time.time() - startTime < simTime):
        ...
        oldTime = time.time()
        robot[0].velControlKin(vel, omega, deltaT)
